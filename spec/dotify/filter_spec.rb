...
module Dotify
  describe Collection::Filter do
    ...
    describe Collection::Filter, "#home" do
      it "should call Collection::Filter#dots with the correct path" do
        Collection::Filter.should_receive(:dots).with("/tmp/home/.*").once.and_return([])
        Collection::Filter.home
      end
      it "should drop files that have been specified to be ignored" do
        Collection::Filter.stub(:dots) do
          [
            Dot.new('.zshrc'),
            Dot.new('.bashrc'),
            Dot.new('.vimrc'),
        ...
        result = Collection::Filter.home.map(&:filename)
    ...
    describe Collection::Filter, "#dotify" do
      it "should call Collection::Filter#dots with the correct path" do
        Collection::Filter.should_receive(:dots).with("/tmp/home/.dotify/.*").once.and_return([])
        Collection::Filter.dotify
      end
      it "should drop files that have been specified to be ignored" do
        Collection::Filter.stub(:dots) do
          [
        ...
        result = Collection::Filter.filenames(Collection::Filter.dotify)
    ...
    describe Collection::Filter, "#dots" do
      let(:glob) { '/spec/test/.*' }
